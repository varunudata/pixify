    ...
    <div className='flex flex-col items-center justify-center my-26 p-6 md:px-28'>
        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            <div>
                ...
                <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our AI image generator. Whether you need stunning visulas or unique imagery, our tool transforms your text into eye-catching images with just a few clicks. Imagine it, describing it, and watch it come to life instantly.</p>
                <p className='text-gray-600'>simpply type in a text prompt, and our cutting edge AI will generate high-quality images in seconds. From product visuals to character designs and portraits, even concepts that don't yet exist can be visualised effortlessly. Powered by advanced AI technology, the creative possibilities are limitless! </p>
            </div>
        </div>
    </div>
  )
